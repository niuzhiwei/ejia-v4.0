...
var pageParams={
	...
	currentStep:1,
	stepEnd:0,
	address:{data:{},type:1,servicename:util.serviceTypeMap(util.urlParam('serviceclass'))},
                		...
                		for(var i=0;i<daylength;i++){
                			...
                			if(date.getDay()==0){
            			 	...
            			 	$('.fill-week>div').each(function(){
			                    var me=$(this);
			                    if(me.hasClass('fill-current')){
			                        if(me.data('weeknum')==date.getDay()){
			                            monthDays.push(util.formatDate('yyyy-MM-dd',date));
			                        }
			                    }
			                })
                		}
