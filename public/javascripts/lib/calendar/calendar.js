    ...
    var Calendar = function (params) {
        ...
        p.monthHTML = function (date, offset) {
            ...
            var dayDate, currentValues = [], i, j,
                ...
                minDate = p.params.minDate ? new Date(p.params.minDate.replace(/-/g,"/")).getTime() : null,
                maxDate = p.params.maxDate ? new Date(p.params.maxDate.replace(/-/g,"/")).getTime() : null;
